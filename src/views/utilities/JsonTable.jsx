...
const defaultSettings = {
  ...
  classPrefix: "json",
  headerClass: () => {
    return "p-0.5 px-1 border-b-2 border-slate-300 bg-slate-100 text-left text-[9px] font-semibold text-slate-700 tracking-wider select-none";
  },
  rowClass: (className) => {
    return `bg-white border-b border-slate-200 text-[9px] select-none text-slate-700 ${className}`;
  },
  cellClass: () => {
    return "px-1 pt-0.5 break-all text-slate-600 text-[9px]";
  }
};
